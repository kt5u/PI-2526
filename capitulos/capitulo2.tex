...
No módulo de registo de reciclagem, foi removida a funcionalidade de reconhecimento automático de objetos devido à instabilidade reportada em versões anteriores, que frequentemente causava o encerramento inesperado (\textit{crash}) da aplicação