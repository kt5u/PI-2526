...
Após a realização de estudos de campo com utilizadores reais, foi possível recolher feedback direto sobre a utilização
...
\clearpage
\section{Rebranding da Aplicação}
\subsection{Objetivo}
Alterar o nome e a terminologia da aplicação para refletir de forma mais adequada a sua finalidade, passando do conceito de 
...
\clearpage
\section{Sistema de Tracking de Utilizador}
\subsection{Objetivo}
